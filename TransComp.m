function [] = TransComp(numfiles,parentdirectory,sampleID)
        ...
        f3path=struct2cell(dir(fullfile(strcat(parentdirectory,f3),...
            ...
            f4path=struct2cell(dir(fullfile(strcat(parentdirectory,f4),...
                ...
                f1path=struct2cell(dir(fullfile(...
                    strcat(parentdirectory,f1),'*NumericalScatter1.txt')));
                f2path=struct2cell(dir(fullfile(...
                    strcat(parentdirectory,f2),'*NumericalScatter1.txt')));
                f3path=struct2cell(dir(fullfile(...
                    strcat(parentdirectory,f3),'*NumericalScatter1.txt')));
                f4path=struct2cell(dir(fullfile(...
                    strcat(parentdirectory,f4),'*NumericalScatter1.txt')));
                f5path=struct2cell(dir(fullfile(...
                    strcat(parentdirectory,f5),'*NumericalScatter1.txt')));
            else if numfiles==6
                    f1path=struct2cell(dir(fullfile(...
...
if numfiles==2
    f1data=dlmread(fullfile(parentdirectory,...
        f1,f1path{1,1}),'\t',[0,0,80,1]);
    f2data=dlmread(fullfile(parentdirectory,...
        f2,f2path{1,1}),'\t',[0,0,80,1]);
else if numfiles==3
        f1data=dlmread(fullfile(parentdirectory,...
            f1,f1path{1,1}),'\t',[0,0,80,1]);
        f2data=dlmread(fullfile(parentdirectory,...
...
if numfiles==2
    plot(f1data(:,1),f1data(:,2),'-ok','LineWidth',2)
    hold on
    plot(f2data(:,1),f2data(:,2),'-or','LineWidth',2)
    hold on
else if numfiles==3
...
graphname1=strcat(parentdirectory,strcat(sampleID,'_NSPlotHighRes'));
